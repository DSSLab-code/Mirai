...
{
    add_entry(TABLE_CNC_DOMAIN, "\x13\x1B\x10\x0C\x13\x14\x1A\x0C\x12\x0C\x13\x14\x22", 30); // cnc.changeme.com
    add_entry(TABLE_CNC_PORT, "\x22\x35", 2);   // 23

    add_entry(TABLE_SCAN_CB_DOMAIN, "\x13\x1B\x10\x0C\x13\x14\x1A\x0C\x12\x0C\x13\x14\x22", 29); // report.changeme.com
